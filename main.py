...
class App(ctk.CTk):
    def __init__(self):
        ...
        # Buttons (Reordenados conforme solicitado)
        ...
        self.batch_generate_button.grid(row=3, column=0, padx=20, pady=5)
        ...
        self.spreadsheet_profile_button.grid(row=4, column=0, padx=20, pady=5)
        ...
        self.document_profile_button.grid(row=5, column=0, padx=20, pady=5)
    ...
    def select_frame_by_name(self, name, profile_to_edit: Optional[SpreadsheetProfile] = None):
        ...
        # Update button styles to highlight active frame with borders and hover color background
        # Hover colors for blue theme: Light: #3276AD, Dark: #144870
